...
namespace VideoRecording
{
    ...
    public class PoseRecorder : MonoBehaviour
    {
        ...
        [Header("Positions")]
        [SerializeField]
        private Transform fallCenterPosition;

        [Header("Camera Settings")]

        // [SerializeField] private int   numberOfCameras        = 10;
        [SerializeField]
        private VaryingValue cameraPositionsAroundCenterRanges = new(new[] { new Range(0, 360, 10) });

        [SerializeField]
        private VaryingValue fovRanges = new(new[] { new Range(60f) });

        [SerializeField]
        private VaryingValue distanceFromCenterRanges = new(new[] { new Range(2f, 7f, 1) });

        [SerializeField]
        private VaryingValue cameraHorizontalRotationAngleRanges = new(new[] { new Range(-10f, +10f, 1) });

        [SerializeField]
        private VaryingValue cameraVerticalRotationAngleRanges = new(new[] { new Range(-10f, +10f, 1) });

        [SerializeField]
        private VaryingValue heightRanges = new(new[] { new Range(1f, 2.5f, 1) });

        [SerializeField]
        private float aboveHeadHeightThreshold = 1.8f;
        ...
        [SerializeField]
        private RecordingMode mode = RecordingMode.Json;

        [SerializeField]
        private string rootOutputFolder = "PoseRecordings";

        [SerializeField]
        private string fileName = "fall_recording";

        [SerializeField]
        private int frameRate = 60;

        [SerializeField]
        private int numberOfPosePoints = 33;

        [SerializeField]
        private bool flipYAxisOutput = false;
